...
export const Login = () => {
  ...
  return (
    <>
      ...
      <div className=" bg-black absolute w-[30vw] h-[60vh] text-gray mt-[24vh] ml-[30%] opacity-80 ">
        <form onSubmit={getInputData}>
          ...
          {!islogin && (
            <input
              ...
              className="  outline-none font-2xl rounded-sm ml-[10%] h-[7vh] w-[25vw] m-2 bg-gray-800 text-white my-2"
              type="text"
          ...
          <input
            ...
            className=" flex flex-col outline-none font-2xl rounded-sm ml-[10%] h-[7vh] w-[25vw] m-2 bg-gray-800 text-white my-2"
            type="text"
          ...
          <input
            ...
            className="  outline-none font-2xl rounded-sm ml-[10%]  m-3 h-[7vh] w-[25vw] bg-gray-800 text-white my-2"
            type="password"
            placeholder=" Enter your Password"
          />
          <button className="bg-red-800  outline-none font-2xl text-white font-bold ml-[10%] h-[7vh] w-[25vw] m-3 ">
